...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-$@h8o3x#!fymqpc%9&$ow@%p0@3&i)5nngdfmlp8#e(*xw5!w(')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = env('DEBUG', default=True)

ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['localhost', '127.0.0.1', 'danielwood-production.up.railway.app'])
...
ACCREDIBLE_API_KEY = env('ACCREDIBLE_API_KEY', default='')
ACCREDIBLE_GROUP_ID = env('ACCREDIBLE_GROUP_ID', default='')
